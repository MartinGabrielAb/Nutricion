...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{$pieza->PiezaNombre}} : Camas</h1>
    ...
    <form onSubmit="guardar(event)">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <label for='numero' id="labelNombre">Número</label>
          <input class="form-control" type="number" id="numero" name="numero" required  min="1" max="99">
        </div>
...
@push('custom-scripts')
<script type="text/javascript" src="{{asset('js/camas/principal.js')}}"></script>
