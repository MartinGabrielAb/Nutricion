      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col">
                <table id="tableRoles" class="table table-sm table-striped table-bordered table-hover display nowrap" style="width:100%" cellspacing="0">
...
@push('custom-scripts')
<script type="text/javascript" src="{{asset('js/roles/principal.js')}}"></script>
