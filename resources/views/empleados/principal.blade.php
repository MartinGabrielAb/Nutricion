...
{{-- Realizar la consulta ajax para la tabla principal de empleados. --}}
@section('contenido')
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
              	...
              	<div class="row">
                  <div class="col">
                    <table id="tableEmpleados" class="table table-sm table-striped table-bordered table-hover display nowrap" style="width:100%" cellspacing="0">
      ...
      <form onSubmit="guardar(event)">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input class="form-control" type="number" id="telefono" name="telefono" minlength="4" maxlength="64">
...
@push('custom-scripts')
  <script type="text/javascript" src="{{asset('js/empleados/principal.js')}}"></script>
@endpush
@endsection