  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Administración de Alimentos por proveedor : {{$alimento->AlimentoNombre}}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/alimentos">Alimentos</a></li>
              <li class="breadcrumb-item active">Alimentos por proveedor</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                  ...
                  <div class="col-lg-8" style="height: 5px">
                    <div id="divMensaje" class="alert"> 
                      ...
                      <button type="button" class="btn btn-sm btn-default" id="btnAgregar" data-toggle="modal" data-target="#modalAgregar">
                        Agregar Alimento por Proveedor
                      </button>
              			</p>	
              		</div>
              	</div>
                @include('alimentos.modal.agregarPorProveedor')	
              	<!--------------TABLA PRINCIPAL-------------->
                <div class="row">
                  <div class="col-lg-12">
...
<script type="text/javascript" src="{{asset('js/alimentosPorProveedor/create.js')}}"></script>
<script type="text/javascript" src="{{asset('js/alimentosPorProveedor/eliminar.js')}}"></script>
<script type="text/javascript" src="{{asset('js/alimentosPorProveedor/editar.js')}}"></script>
