...
@endphp
<div class="modal fade" id="modalAgregarDetalleRelevamiento" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-inline">
              <select class="form-control" id="pacienteId" name="pacienteId" style="width: 70%">
                <option></option>
                @foreach ($pacientes as $paciente)
                    <option value="{{$paciente->PersonaCuil}}">{{$paciente->PersonaApellido}}, {{$paciente->PersonaNombre}} - {{$paciente->PersonaCuil}}</option>
                @endforeach
              </select>
              <button type="button" id="ultimoRelevamientoId" class="btn btn-sm btn-default ml-2">Últ. relevamiento</button>
          </div>
          <label for="camaId">Sala/Pieza/Cama</label>
          <div class="form-inline">
            <select class="form-control" name="camaId" id="camaId" style="width: 70%">
              <option></option>
          ...
          <label for="tipoPacienteId">Tipo de Paciente</label>
          <div class="form-inline">
              <select class="form-control" id="tipoPacienteId" name="tipoPacienteId" style="width: 70%">
                <option></option>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-5">
                ...
                @include('relevamientos.modal.validaciones')	
              </div>
            </div>
          </div>
        </div>
