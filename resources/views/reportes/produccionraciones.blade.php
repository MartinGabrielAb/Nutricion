...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reportes de Producción de Raciones</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/">Home</a></li>
            <li class="breadcrumb-item active">Producción de Raciones</li>
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="card-body">
            ...
            <div class="form-group row justify-content-md-center mb-0">
                <div class="col-auto mr-auto ml-auto">
                    <button type="submit" onclick="getReporteProduccionRaciones(event)" class="btn btn-primary">Generar</button>
                </div>
            </div>
            <div class="row">
...
@push('custom-scripts')
  <script type="text/javascript" src="{{asset('js/reportes/produccionraciones.js')}}"></script>
@endpush
