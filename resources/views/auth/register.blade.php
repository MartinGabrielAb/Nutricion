                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="checkbox" name="roles[]" id="rolAdministrador" value="Administrador">
                              <label class="form-check-label" for="rolAdministrador">Administrador</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="checkbox" name="roles[]" id="rolCocinero" value="Cocinero">
                              <label class="form-check-label" for="rolCocinero">Cocinero</label>
                            </div>
                            <div class="form-check form-check-inline">
                        ...
                        <div class="form-group row">
                            <label for="roles" class="col-md-4 col-form-label text-md-right">{{ __('') }}</label>
                            <div class="form-check form-check-inline">
