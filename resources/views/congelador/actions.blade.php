{{-- <a href="{{route('congelador.show',$CongeladorId)}}" class="btn btn-sm btn-default ml-1 mr-1 pl-3 pr-3">Detalles</a> --}}
...
<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <button class="dropdown-item" onClick ="eliminar({{$CongeladorId}})" ><i class="fas fa-exclamation-circle"></i>Confirmar eliminación</button>
</div>
