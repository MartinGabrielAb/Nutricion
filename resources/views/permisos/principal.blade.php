...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{$rol->name}}:Permisos</h1>
        </div>
        <div class="col-sm-6">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col">
                <table id="tablePermisos" class="table table-sm table-striped table-bordered table-hover display nowrap" style="width:100%" cellspacing="0">
    ...
    <form onSubmit="guardar(event)">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <input type="hidden" id="rolId" name="rolId" value="{{$rol->id}}">  
            <label for='permisos' id="labelPermisos">Permisos:</label><small class="ml-2">Seleccione varios apretando CTRL</small>
            <select id="permisos" class="form-control custom-select " multiple  required>
...
@push('custom-scripts')
<script type="text/javascript" src="{{asset('js/permisos/principal.js')}}"></script>
