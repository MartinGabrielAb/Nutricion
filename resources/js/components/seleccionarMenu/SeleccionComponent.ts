...
export default {
    ...
    methods :{
            ...
            getRelevamiento(){
                axios.get('/api/getRelevamiento/'+this.relevamientoAnteriorId)
                .then(response =>{
