...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $permission = Permission::create(['name' => 'seleccionarMenu.store'])->syncRoles(['Admin']);
        // $permission = Permission::create(['name' => 'seleccionarMenu.index'])->syncRoles(['Admin']);
        // $permission = Permission::create(['name' => 'seleccionarMenu.create'])->syncRoles(['Admin']);
        // $permission = Permission::create(['name' => 'seleccionarMenu.update'])->syncRoles(['Admin']);
        // $permission = Permission::create(['name' => 'seleccionarMenu.show'])->syncRoles(['Admin']);
